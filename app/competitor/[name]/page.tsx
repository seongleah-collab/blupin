    ...
    <div className="flex h-screen bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <header className="px-8 pt-6 pb-2">
          <Link
            href="/feed"
            className="inline-flex items-center gap-1.5 text-[12px] text-neutral-500 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors mb-3"
          >
          ...
          <h1 className="text-3xl md:text-4xl text-neutral-900 dark:text-neutral-100 leading-tight">
            <span className={`${fraunces.className} italic font-medium`}>{decodedName}</span>.
          </h1>
        </header>
        ...
        <main className="flex-1 overflow-y-auto px-8 pb-12 pt-4">
          <div className="max-w-4xl space-y-6">
            ...
            <div className="rounded-2xl glass-card dark:bg-neutral-900 dark:shadow-none border border-transparent dark:border-neutral-800 px-5 py-4 flex items-center gap-6 flex-wrap">
              <div>
            ...
            {loading ? (
              ...
              <div className="rounded-2xl glass-card dark:bg-neutral-900 dark:shadow-none p-10 text-center text-sm text-neutral-500 dark:text-neutral-400">
              ...
              <ul className="space-y-3">
                {events.map((e) => {
                  ...
                  return (
                    <li
                      key={e.id}
                      className="rounded-2xl glass-card dark:bg-neutral-900 dark:shadow-none border border-transparent dark:border-neutral-800 px-5 py-4"
                    >
